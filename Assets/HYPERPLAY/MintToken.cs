...
public class MintToken : MonoBehaviour
{
    async public void OnMintToken()
    {
        ...
        // call publicMint function https://docs.hyperplaygaming.com/api/rpc-endpoint/rpc-call-examples/send-transaction
        string jsonString = "{ \"request\": { \"method\": \"eth_sendTransaction\", \"params\": [{ \"from\": \"" + account + "\", \"to\": \"0xDD6ff2bA7fD02D19e8e4e1d99b65802eD9705437\", \"value\": \"0\", \"data\": \"0x26092b83\" }] }, \"chain\": { \"chainId\": \"5\" } }";
